    ...
    >
      ...
      <td>
        <div className="space-y-1">
          <span className="text-xs font-mono">{format(user.remainingSeconds)}</span>
      ...
      <td className="p-4">
        <div className="flex justify-end gap-1">
          <Button size="icon" variant="outline" onClick={() => onOpen("sessions")}>
            <Smartphone size={16} />
          </Button>
          <Button size="icon" variant="outline" onClick={() => onOpen("time")}>
            <Clock size={16} />
          </Button>
          <Button size="icon" variant="outline" onClick={() => onOpen("move")}>
            <RefreshCcw size={16} />
          </Button>
          <Button size="icon" variant="destructive" onClick={() => onOpen("delete")}>
            <Trash2 size={16} />
          </Button>
        </div>
      </td>
